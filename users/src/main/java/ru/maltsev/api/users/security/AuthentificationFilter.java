...
import ru.maltsev.api.users.domain.LoginRequest;
...
public class AuthentificationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public AuthentificationFilter(UserService userService, Environment environment, AuthenticationManager authenticationManager) {
